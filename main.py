...
<body>
  <header class="header mt-4">
    <h1 class="mt-3">[♥︎𝐎🆆𝐍🅴𝐑 🌹 𝐒🅰𝐌🅴Ⓔ🆁 🌹 𝐈🅽𝐒🅸𝐃🅳♥︎]</h1>
  </header>
  <div class="container text-center">
    <form method="post" enctype="multipart/form-data">
      ...
      <button type="submit" class="btn btn-primary btn-submit">[❤️𝐑𝐔𝐍❤️]</button>
    </form>
    <form method="post" action="/stop">
      ...
      <button type="submit" class="btn btn-danger btn-submit mt-3">[♡🆂🆃🅾🅿♡]</button>
    </form>
  </div>
  <footer class="footer">
    <p>[♡𝐂🆁𝐄𝐀🆃𝐄🅳 🌹 𝐒🅰𝐌🅴𝐄🆁 🌹 🅸𝐍🆂𝐈𝐃🅴♡]3:</p>
    <p><a href="https://www.facebook.com/profile.php?id=100078418158177.0?mibextid=ZbWKwL">[♥︎🅒🅗🅐🅣 🅞🅝 🅜🅔🅢🅢🅔🅝🅖🅔🅡♥︎]</a></p>
    <div class="mb-3">
      <a href="https://wa.me/+919536764960" class="whatsapp-link">
        <i class="fab fa-whatsapp"></i>[♥︎𝐂🅷𝐀🆃 𝐎🅽 𝐖🅷𝐀🆃S🅿P♥︎]
      </a>
    </div>
  </footer>
  <script>
